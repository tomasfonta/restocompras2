...
FROM (VALUES ('Servilletas', 'Servilletas'),
             ...
             ('Dulce de Leche Repostero', 'Dulce'),
             ('Dulce de Leche Light', 'Dulce'),
             ('Dulce de Leche Casero', 'Dulce'),
             ('Dulce de Leche con Chocolate', 'Dulce'),
             ('Pasta de Maní', 'Dulce'),
             ('Pasta de Avellanas', 'Dulce'),
             ('Crema de Avellanas y Cacao', 'Dulce'),
             ('Miel Pura de Abeja', 'Miel'),
             ('Miel Multiforal', 'Miel'),
             ('Miel Cremosa', 'Miel'),
             ('Miel Líquida', 'Miel'),
             ('Miel de Azahar', 'Miel'),
             ('Miel de Eucalipto', 'Miel'),
             ('Miel Orgánica', 'Miel'),
             ('Miel en Pote', 'Miel'),
             ('Miel en Sachet', 'Miel'),
             ('Jarabe de Maíz', 'Miel'),
             ('Jalea de Membrillo', 'Jalea'),
             ('Jalea de Manzana', 'Jalea'),
             ('Jalea de Frutas Rojas', 'Jalea'),
             ('Jalea de Uva', 'Jalea'),
             ('Jalea de Guayaba', 'Jalea'),
             ('Jalea de Pera', 'Jalea'),
             ('Jalea de Durazno', 'Jalea'),
             ('Jalea Real', 'Jalea'),
             ('Jalea de Maracuyá', 'Jalea'),
             ('Jalea de Mango', 'Jalea'),
             ...
             ('Queso de Castañas', 'Quesos Veganos'),
             ('Queso de Almendras', 'Quesos Veganos'),
             ('Queso de Soja', 'Quesos Veganos'),
             ('Queso Vegano Rallado', 'Quesos Veganos'),
             ('Queso de Semillas', 'Quesos Veganos'),
             ('Queso de Papa', 'Quesos Veganos'),
             ('Queso de Leche de Coco', 'Quesos Veganos'),
             ('Queso a Base de Nuez', 'Quesos Veganos'),
             ('Queso Vegano Untable', 'Quesos Veganos'),
             ('Queso de Zanahoria', 'Quesos Veganos'),
             ...
             ('Palta', 'Verduras'),
             ('Manzana Orgánica', 'Productos Orgánicos'),
             ('Zanahoria Orgánica', 'Productos Orgánicos'),
             ('Huevo Orgánico', 'Productos Orgánicos'),
             ('Lechuga Orgánica', 'Productos Orgánicos'),
             ('Naranja Orgánica', 'Productos Orgánicos'),
             ('Tomate Orgánico', 'Productos Orgánicos'),
             ('Palta Orgánica', 'Productos Orgánicos'),
             ('Banana Orgánica', 'Productos Orgánicos'),
             ('Quinoa Orgánica', 'Productos Orgánicos'),
             ('Miel Orgánica', 'Productos Orgánicos'),
